 ...
 * API-local copy — compiled into dist/ by nest build.
 *
 * Also exists at packages/config/sentry/pii-scrub.ts for Next.js apps
 * (which webpack-bundle it at build time). Duplication intentional:
 * tsc-only API build cannot load .ts at runtime.
 *
