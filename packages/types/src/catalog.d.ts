...
export type AdjustmentReason = 'RESTOCK' | 'DAMAGE' | 'RETURN' | 'CORRECTION' | 'SALE' | 'RESERVATION_RELEASE';
export type SortOrder = 'relevance' | 'price_asc' | 'price_desc' | 'newest' | 'rating' | 'best_sellers';
